    ...
    override func spec() {
        describe("getString function") {
            it("retrieves string from the cache for provided key") {
                RealRemoteConfig.shared.cache = createCacheMock(initialContents: ["body": ["foo": "moo"]])
        ...
        describe("getBoolean function") {
            it("retrieves boolean from the cache for provided key") {
                RealRemoteConfig.shared.cache = createCacheMock(initialContents: ["body": ["foo": "true"]])
        ...
        describe("getNumber function") {
            it("retrieves number from the cache for provided key") {
                RealRemoteConfig.shared.cache = createCacheMock(initialContents: ["body": ["foo": "10"]])
        ...
        describe("getConfig function") {
            it("returns the config cache dictionary") {
                RealRemoteConfig.shared.cache = createCacheMock(initialContents: ["body": ["foo": "bar", "moo": "100"]])
